...
@interessado_routes.get("/interessados/listar/{imovel_id}", dependencies=[Depends(check_token)])
...
@interessado_routes.get("/interessados/visualizar/{interessado_id}", dependencies=[Depends(check_token)])
...
@interessado_routes.put("/interessados/atualizar/{interessado_id}", dependencies=[Depends(check_token)])
...
@interessado_routes.delete("/interessados/deletar/{interessado_id}", dependencies=[Depends(check_token)])
