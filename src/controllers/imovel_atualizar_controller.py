...
class ImovelAtualizarController(ImovelAtualizarControllerInterface):
    ...
    async def atualizar(self, imovel_data: dict, clean_loc: bool) -> dict:
        imovel = await self.__atualizar_imovel(imovel_data, clean_loc)
        return self.__format__response(imovel)

    async def __atualizar_imovel(self, imovel_data: dict, clean_loc: bool) -> Imovel:
        return await self._imovel_repository.atualizar_imovel(imovel_data, clean_loc)
